...
GAME( 1990, fireshrk,   0,        samesame, fireshrk,  toaplan1_state, fireshrk, ROT270, "Toaplan", "Fire Shark", MACHINE_NO_SOUND )
GAME( 1989, fireshrka,  fireshrk, samesame, fireshrka, toaplan1_state, fireshrk, ROT270, "Toaplan", "Fire Shark (earlier)", MACHINE_NO_SOUND )
GAME( 1990, fireshrkd,  fireshrk, samesame, samesame2, toaplan1_state, fireshrk, ROT270, "Toaplan (Dooyong license)", "Fire Shark (Korea, set 1, easier)", MACHINE_NO_SOUND )
GAME( 1990, fireshrkdh, fireshrk, samesame, samesame2, toaplan1_state, fireshrk, ROT270, "Toaplan (Dooyong license)", "Fire Shark (Korea, set 2, harder)", MACHINE_NO_SOUND )
GAME( 1989, samesame,   fireshrk, samesame, samesame,  toaplan1_state, fireshrk, ROT270, "Toaplan", "Same! Same! Same! (1P set)", MACHINE_NO_SOUND )
GAME( 1989, samesame2,  fireshrk, samesame, samesame2, toaplan1_state, fireshrk, ROT270, "Toaplan", "Same! Same! Same! (2P set)", MACHINE_NO_SOUND )
