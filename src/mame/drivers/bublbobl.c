...
ROM_START( bublredux )
	...
	ROM_LOAD( "bb4",          0x18000, 0x08000, CRC(19a5a0fa) )
	/* 20000-2ffff empty */
...
GAME( 2013, bublcave,  	bublbobl, bublbobl, bublbobl, 	bublbobl_state, bublbobl, ROT0,  "hack by Bisboch and Aladar", "Bubble Bobble Lost Cave (Ver 1.2)", MACHINE_SUPPORTS_SAVE )
GAME( 2013, bublredux,  bublbobl, boblbobl, boblbobl, 	bublbobl_state, bublbobl, ROT0,  "hack by Punji", "Bubble Bobble Redux (With Level Skipper)", MACHINE_SUPPORTS_SAVE )
