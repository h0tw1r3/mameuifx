...
GAMEL(2012, outrunen,  outrun,  outrun,          outrun,   segaorun_state,outrun,  ROT0,   "hack by YT",    "Out Run Enhanced Edition (Ver 1.0.3)", 0,                    layout_outrun ) // Upright/Sitdown determined by dipswitch settings
