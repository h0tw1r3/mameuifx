...
ROM_START( ketarr17 )
	ROM_REGION( 0x600000, "maincpu", 0 ) /* 68000 Code */
	/* doesn't use a separate BIOS rom */
	ROM_LOAD16_WORD_SWAP( "ketsui_v100.u38", 0x000000, 0x200000, CRC(2cb80b89) SHA1(9aaba1242d7ce29915a31d40341da82985927f9d) )
...
GAME( 2012, ketarr,       ket,       pgm_arm_type1_cave,    pgm, pgm_arm_type1_state,     ket,       ROT270, "hack by Trap15", 	   "Ketsui: Arrange (2012/04/17 Arrange Ver. 1.0)", 		MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
GAME( 2012, ketarr17,     ket,       pgm_arm_type1_cave,    pgm, pgm_arm_type1_state,     ket,       ROT270, "hack by Trap15", 	   "Ketsui: Arrange (2014/07/16 Arrange Ver. 1.7)", 		MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
