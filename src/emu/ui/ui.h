...
/* handy colors */
#define ARGB_WHITE              rgb_t(255,255,255,255)
#define ARGB_BLACK              rgb_t(255,0,0,0)
#define UI_BORDER_COLOR         rgb_t(255,0,0,0)
#define UI_BACKGROUND_COLOR     rgb_t(255,195,195,195)
#define UI_GFXVIEWER_BG_COLOR   rgb_t(255,0,0,0)
#define UI_GREEN_COLOR          rgb_t(255,34,177,76)
#define UI_YELLOW_COLOR         rgb_t(255,215,204,0)
#define UI_RED_COLOR            rgb_t(255,237,28,36)
#define UI_UNAVAILABLE_COLOR    rgb_t(255,127,127,127)
#define UI_TEXT_COLOR           rgb_t(255,0,0,0)
#define UI_TEXT_BG_COLOR        rgb_t(255,195,195,195)
...
#define UI_SELECTED_BG_COLOR    rgb_t(255,63,72,204)
#define UI_MOUSEOVER_COLOR      rgb_t(255,255,242,0)
#define UI_MOUSEOVER_BG_COLOR   rgb_t(255,0,162,232)
#define UI_MOUSEDOWN_COLOR      rgb_t(255,255,242,0)
#define UI_MOUSEDOWN_BG_COLOR   rgb_t(255,0,162,232)
#define UI_DIPSW_COLOR          rgb_t(255,127,127,127)
#define UI_SLIDER_COLOR         rgb_t(255,34,177,76)
