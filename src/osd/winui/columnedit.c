	...
	void (*pfnSetColumnInfo)(int *pnOrder, int *pnShown))
{
	...
	case WM_INITDIALOG:
		...
		{
			(void)ListView_SetExtendedListViewStyle(hShown, LVS_EX_FULLROWSELECT | LVS_EX_DOUBLEBUFFER);
			(void)ListView_SetExtendedListViewStyle(hAvailable, LVS_EX_FULLROWSELECT | LVS_EX_DOUBLEBUFFER);
		}
		else
		{
